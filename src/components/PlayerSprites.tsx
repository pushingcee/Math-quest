export const playerSprites = [
  ...
  `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="12" y="10" width="8" height="6" fill="#e74c3c"/> //fill = accent
  ...
  `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="13" y="6" width="6" height="3" fill="#2ecc71"/> fill = accent
    <rect x="11" y="12" width="10" height="8" fill="#2ecc71"/> fill = accent
  ...
  `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="11" y="19" width="10" height="5" fill="#f39c12"/> fill = accent
