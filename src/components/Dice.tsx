...
export default function Dice({ value, isRolling, label, onClick }: DiceProps) {
  return (
    <div className="fixed left-1/2 top-1/2 z-[100] -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white/95 p-8 text-center shadow-xl [touch-action:manipulation]">
      <div
        onClick={onClick}
